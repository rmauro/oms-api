...
export const providers = [
  {
    ...
    useFactory: (connection: Connection) => connection.model('Action', ActionSchema)
  },
  {
    provide: ORDER_MODEL,
    inject: [DATABASE_CONNECTION],
  ...
  },
  {
    ...
    inject: [DATABASE_CONNECTION],
    useFactory: (connection: Connection) => connection.model('ProcessingRule', ProcessingRuleSchema)
  },
